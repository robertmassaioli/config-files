...
highlight Comment    term=bold      ctermfg=Green                   guifg=#d1ddff
highlight Constant   term=bold      ctermfg=207                         guifg=#ffa0a0
highlight Number     term=underline ctermfg=Green                       guifg=Yellow
highlight Identifier term=bold      ctermfg=LightBlue                   guifg=#40ffff
highlight Function   term=bold      ctermfg=Blue                   guifg=#40ffff
highlight Statement  term=bold      ctermfg=Yellow           gui=bold   guifg=#ffff60
highlight PreProc    term=underline ctermfg=221                        guifg=#ff4500
highlight Type       term=underline ctermfg=Yellow         gui=bold     guifg=#7d96ff
...
highlight Todo                      ctermfg=White       ctermbg=DarkGreen  guifg=Blue     guibg=Yellow
...
highlight SpecialChar               ctermfg=Grey      ctermbg=None   guifg=Black    guibg=LightGray
